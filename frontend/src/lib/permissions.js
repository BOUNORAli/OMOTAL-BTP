...
export const ROLE_PERMS = {
  ...
  DIRECTEUR: [
    ...
    "production.read", "fournisseurs.read", "rentabilite.read",
  ...
  RESPONSABLE_CHANTIER: [
    ...
    "fournisseurs.read", "validations.operational", "alertes.read",
  ],
  POINTEUR: [
    "dashboard.chantier", "chantier.read", "gasoil.create_sortie", "engins.read",
    "engins.pointage", "production.read", "production.create",
  ],
  COMPTABLE: [
    "dashboard.global", "chantier.read", "caisse.read", "caisse.create",
    "gasoil.read", "gasoil.create_entree", "personnel.read", "personnel.create",
    "personnel.read_salary", "engins.read", "engins.pay",
    "fournisseurs.read", "fournisseurs.create", "production.read",
    "rentabilite.read", "reports.export", "alertes.read",
  ],
